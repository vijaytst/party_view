...
const YoutubeChatForm = ({ userInfo, partyId }) => {
...
console.log('socket error recieved')
console.log(error)
    })
      ...
      <form onSubmit={handleSubmit} className="flex items-center h-10">
        <div className="flex items-center ">
          ...
          <input
            ...
            value={value.message}
            placeholder="Comment on the youtube party here...."
...
export default YoutubeChatForm;

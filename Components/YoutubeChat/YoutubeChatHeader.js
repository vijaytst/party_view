...
const YoutubeChatHeader = ({ partyInfo }) => {
    ...
    <div style={{height:'30%'}}>
      ...
      >
        ...
        <FacebookShareButton
          ...
          url={`https://viewingparty.net/youtube/${partyInfo._id}/${partyInfo?.partyTitle}`}
        >
        ...
        <div  className='ml-2' >
        <CopyToClipboard
            text={`https://viewingparty.net/youtube/${partyInfo._id}/${partyInfo?.partyTitle}`}
...
export default YoutubeChatHeader;

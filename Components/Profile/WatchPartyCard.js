    ...
    <div className="bg-gray-900 pb-5 group hover:scale-105 duration-200 transform rounded-b-2xl bg-opacity-25">
      ...
      <div className="px-5">
        <div className="flex justify-between items-center pt-4 pb-2">
          <h4 className="text-white text-lg">{originalName}</h4>
        ...
        <div className={"flex items-center justify-between"}>
          <div className="flex mt-1">
            ...
            <button className="w-8 h-8 outline-none rounded-full grid place-content-center border border-gray-300 group duration-200 hover:border-primary hover:bg-gray-900 ml-3">
              <EditFilled className="text-gray-300 group-hover:text-primary duration-200" />
            </button>
            <button
              onClick={() => deleteParty(_id)}
              className="w-8 h-8 outline-none rounded-full grid place-content-center border border-gray-300 group duration-200 hover:border-transparent hover:bg-red-600 ml-3"
            >
              <DeleteFilled className="text-gray-300 group-hover:text-gray-50 duration-200" />
            </button>
          </div>
          <div>
            <button
